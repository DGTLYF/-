...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'next', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','nobelium','simeple'] 
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '稚乖画册', // 昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '原创写真社团', // 简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://weibo.com/u/7709827944', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '购物,娱乐', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/7709827944', // 微博个人主页
