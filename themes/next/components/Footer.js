  ...
  return (
    ...
    >
      ...
      <span>
        ...
        <br />
        <h1>{title}</h1>
        <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '>Powered by  <a href='https://weibo.com/u/7709827944' className='underline '>稚乖画册 {BLOG.VERSION}</a>.</span>
      </span>
    </footer>
  )
}
